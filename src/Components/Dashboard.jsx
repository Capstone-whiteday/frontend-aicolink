...
// import { LabelList } from 'recharts'; // 🟢 반드시 추가!
// import {
...
//           </p>
//         </div>
//         {/* 카드 5: 총 요금 대비 절감 요금 (항상 바 차트와 값이 보이도록 Tooltip 완전 제거, LabelList 추가) */}
// <div style={cardStyle}>
//   <p style={{ margin: '-20px 0 2px 0', fontSize: 16, textAlign: 'left', fontWeight: 600 }}>
//     총 요금 대비 절감 요금
//   </p>
...
//               formatter={value => value ? `${value.toLocaleString()} 원` : ''}
//               style={{ fill: '#222', fontWeight: 700, fontSize: 16 }}
//             />
//           </Bar>
//         </BarChart>
//       </ResponsiveContainer>
